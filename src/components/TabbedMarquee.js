...
export default class TabbedIndexSection extends Component {
    constructor(props) {
        ...
        var period = this.props.period ? this.props.period : 4000
        this.interval = props.autoChange == false ? null : setInterval(() => {this.setState({tab: (this.state.tab + 1) % this.tabs.length})}, period)
    }
